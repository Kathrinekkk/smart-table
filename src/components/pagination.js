...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    ...
    pages.firstElementChild.remove();                                // и удаляем его (предполагаем, что там больше ничего, как вариант, можно и всё удалить из pages)                                         // очищаем контейнер (лучше использовать innerHTML)
